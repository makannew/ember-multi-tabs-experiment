...
return t&&!t.internal&&"component"===t.type?t.factory:void 0},e.setModifierManager=function(e,t){return zr({factory:e,internal:!1,type:"modifier"},t)},e.getModifierManager=Ur,e.modifierCapabilities=function(e,t){void 0===t&&(t={})
...
return r}function Te(e,t){return e.get(t)}function Ae(e,t){return"attrs"===t[0]&&(t.shift(),1===t.length)?Te(e,t[0]):Oe(e,t)}var Se,ke,Ce=function(e){var t=e.indexOf(":")
if(-1===t)return[e,e,!0]
...
b.EMBER_COMPONENT_IS_VISIBLE&&"style"===s&&void 0!==Se&&(c=new Se(t,c,Te(t,"isVisible"),o)),n.setAttribute(s,c,!1,null)},Me="display: none;",xe=ce(Me)
...
if(!1!==t)return e
if(e){var r=e+" "+Me
return de(e)?ce(r):r}return xe},t.get=function(){return d.UNDEFINED_REFERENCE},e}(),ke=function(e,t,r){t.setAttribute("style",new Se(e,d.UNDEFINED_REFERENCE,e.get("isVisible"),r),!1,null)})
...
var $e=(0,E.privatize)(N()),We=[];(0,l.debugFreeze)(We)
...
a[d]=t.positional.at(c)}}return{positional:y.EMPTY_ARRAY,named:a}},i.create=function(e,t,r,n,i,o){var a=n.view,s=t.ComponentClass,l=r.named.capture(),c=Ve(l);(function(e,t){e.named.has("id")&&(t.elementId=t.id)})(r,c),c.parentView=a,c[B]=o,c._target=i.value(),t.template&&(c.layout=t.template)
...
if(l&&l.length)(function(e,t,r,n,i){for(var o=[],a=e.length-1;-1!==a;){var u=e[a],l=Ce(u),c=l[1];-1===o.indexOf(c)&&(o.push(c),Pe(t,r,l,n,i)),a--}if(-1===o.indexOf("id")){var h=t.elementId?t.elementId:(0,s.guidFor)(t)
n.setAttribute("id",d.PrimitiveReference.create(h),!1,null)}b.EMBER_COMPONENT_IS_VISIBLE&&void 0!==ke&&-1===o.indexOf("style")&&ke(r,n,i)})(l,n,a,r,o)
else{var f=n.elementId?n.elementId:(0,s.guidFor)(n)
r.setAttribute("id",d.PrimitiveReference.create(f),!1,null),b.EMBER_COMPONENT_IS_VISIBLE&&ke(a,r,o)}if(i){var p=new Ne(i,i.propertyKey)
...
return t?(0,h.combine)([t.tag,r[U]]):r[U]},i.didCreate=function(e){var t=e.component
...
this.state={name:r.fullName.slice(10),capabilities:nt,ComponentClass:r}}return e.prototype.getTag=function(e){return e.component[U]},e}()
...
function kt(e){return e.capabilities.asyncLifeCycleCallbacks}function Ct(e){return e.capabilities.updateHook}var Pt=new(function(e){function n(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(n,e)
var o=n.prototype
...
kt(t)&&t.didCreateComponent(r)},o.didUpdate=function(e){var t=e.delegate,r=e.component;(function(e){return kt(e)&&Ct(e)})(t)&&t.didUpdateComponent(r)},o.getContext=function(e){var t=e.delegate,r=e.component
...
return e.extra.debugRenderTree.create(o,{type:"component",name:n,args:r.capture(),instance:null,template:i}),(0,d.registerDestructor)(o,(function(){o.environment.extra.debugRenderTree.willDestroy(o)})),o}return null},n.getSelf=function(){return d.NULL_REFERENCE},n.getTag=function(){return g.ENV._DEBUG_RENDER_TREE?(0,h.createTag)():h.CONSTANT_TAG},n.getDestroyable=function(e){return g.ENV._DEBUG_RENDER_TREE?e:null},n.didRenderLayout=function(e,t){g.ENV._DEBUG_RENDER_TREE&&e.environment.extra.debugRenderTree.didRender(e,t)},n.update=function(e){g.ENV._DEBUG_RENDER_TREE&&e.environment.extra.debugRenderTree.update(e)},n.didUpdateLayout=function(e,t){g.ENV._DEBUG_RENDER_TREE&&e.environment.extra.debugRenderTree.didRender(e,t)},r}(fe)),Ft=function(){function e(e,t){this.name=e,this.template=t,this.manager=jt}return(0,t.createClass)(e,[{key:"state",get:function(){return this}}]),e}(),Lt=function(e){return e.positional.at(0)},zt=function(e){return e.positional.at(0)}
function Bt(e){var t=e.positional,r=t.at(0).value().split("."),n=r[r.length-1],i=t.at(1).value()
...
return"function"==typeof n[je]?n[je].apply(n,i.concat(a)):t.call.apply(t,[Gt].concat(i,a))}}function Wt(e){var t=e.positional,r=t.at(0).value()
...
return t.get=function(e){return new kr(this,e)},t.value=function(){return this.outletState},t.update=function(e){this.outletState.outlets.main=e,(0,h.dirtyTag)(this.tag)},e}(),Sr=function(){function e(e,t){this.parentStateRef=e,this.outletNameRef=t,this.tag=(0,h.combine)([e.tag,t.tag])}var t=e.prototype
...
return function(){return Ue(e,t.value(),r.value(),n,i).apply(void 0,arguments)}}(a.value(),c,s,d,l))[ze]=!0,new Re(r,t.env)},array:function(e){return e.positional.capture()},concat:function(e,t){return new c.HelperRootReference(Ht,e.capture(),t.env)},fn:function(e,t){var r=$t
...
return null==i||""===i?d.NULL_REFERENCE:"string"==typeof i&&i.indexOf(".")>-1?Oe(r,i.split(".")):r.get(String(i))}return new Yt(e.capture(),t.env)},hash:Jt,log:function(e,t){return new c.HelperRootReference(Xt,e.capture(),t.env)},mut:function(e,t){var r=e.positional.at(0)
...
return new er(r,t.env)},unbound:function(e,t){return new Re(e.positional.at(0).value(),t.env)},unless:function(e,t){return new c.HelperRootReference(Kt,e.capture(),t.env)},"-hash":Jt,"-each-in":function(e){return new ht(e.positional.at(0))},"-normalize-class":function(e,t){return new c.HelperRootReference(Bt,e.capture(),t.env)},"-track-array":function(e){return new Ut(e.positional.at(0))},"-get-dynamic-var":d.getDynamicVar,"-mount":function(e,t){var r=t.env,n=e.positional.at(0),i=null
...
if(null===a.component?g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS&&(l=new Ft(i,r)):(0,O.isTemplateOnlyComponent)(a.component.class)&&(l=new Ft(i,r)),null!==a.component){var c=a.component.class,d=Br(c)
...
return oe(new ke(t),Ce)},e.isComputed=function(e,t){return Boolean(se(e,t))},e.getCachedValueFor=function(e,t){var n=(0,r.peekMeta)(e)
...
Array.isArray(e)?W(e,t,r,n):e.replace(t,r,n)},e.replaceInNativeArray=W,e.addArrayObserver=function(e,t,r){return Y(e,t,r,p,!1)},e.removeArrayObserver=function(e,t,r){return Y(e,t,r,m,!0)},e.arrayContentWillChange=V,e.arrayContentDidChange=H,e.eachProxyArrayWillChange=function(e,t,r,n){var i=je.get(e)
...
return U((function(){for(var r,n=Object.keys(t),i=0;i<n.length;i++)r=n[i],Oe(e,r,t[r])})),t},e.expandProperties=he,e.addObserver=E,e.activateObserver=O,e.removeObserver=R,e.flushAsyncObservers=function(e){void 0===e&&(e=!0)
...
return u.CONSTANT_TAG},e.markObjectAsDirty=I,e.tracked=Et,e.addNamespace=function(e){He.unprocessedNamespaces=!0,Ge.push(e)},e.classToString=Qe,e.findNamespace=function(e){Ve||Je()
return $e[e]}
e.findNamespaces=We,e.processNamespace=Ye,e.processAllNamespaces=Je,e.removeNamespace=function(e){var t=(0,n.getName)(e)
...
null!==o&&(o.isInitializing()||o.isPrototypeMeta(e))||(I(e,t),F<=0&&P(),j in e&&(4===arguments.length?e[j](t,i):e[j](t)))}function z(){F++,T=!0}function B(){--F<=0&&(P(),function(){T=!1
for(var e,r=(0,t.createForOfIteratorHelperLoose)(A);!(e=r()).done;){var n=e.value
S(n[0],n[1],n[2])}A=[]}())}function U(e){z()
...
var n,i=(0,r.meta)(e),o=(0,u.tagMetaFor)(e),a=(0,u.tagFor)(e,t,o),s=i.revisionFor(t)
if(void 0!==s&&(0,u.validateTag)(a,s))n=i.valueFor(t)
else{var l=this._getter,c=(0,u.track)((function(){n=l.call(e,t)}));(0,u.updateTag)(a,c),i.setValueFor(t,n),i.setRevisionFor(t,(0,u.valueForTag)(a)),Q(i,t,n)}return(0,u.consumeTag)(a),Array.isArray(n)&&(0,u.consumeTag)((0,u.tagFor)(n,"[]",o)),n},n}(Se),Ce=function(e){function r(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(r,e)
var n=r.prototype
...
if(ee(t)){var n=oe(new Se([]),Ce)
return n(t[0],t[1],t[2])}return oe(new Se(t),Ce)}var Me=Pe.bind(null)
...
return void 0!==l&&(0,u.validateTag)(s,l)||((0,u.updateTag)(s,X(e,this.altKey,a,o)),o.setRevisionFor(t,(0,u.valueForTag)(s)),Q(o,t,n)),(0,u.consumeTag)(s),n},i.set=function(e,t,r){return Oe(e,this.altKey,r)},i.readOnly=function(){this.set=Ne},i.oneWay=function(){this.set=Ie},n}(re)
function Ne(e,t){throw new c.default("Cannot set read-only property '"+t+"' on object: "+(0,n.inspect)(e))}function Ie(e,t,r){return pe(e,t,null),Oe(e,t,r)}var je=new WeakMap
...
var Ue=Object.prototype.hasOwnProperty,Ve=!1,He={_set:0,_unprocessedNamespaces:!1,get unprocessedNamespaces(){return this._unprocessedNamespaces},set unprocessedNamespaces(e){this._set++,this._unprocessedNamespaces=e}},qe=!1,Ge=[]
e.NAMESPACES=Ge
...
s&&(0,n.setName)(s,a)}}}function Ye(e){Xe([e.toString()],e,new Set)}function Je(){var e=He.unprocessedNamespaces
if(e&&(We(),He.unprocessedNamespaces=!1),e||qe){for(var t=Ge,r=0;r<t.length;r++)Ye(t[r])
...
for(var a in $e[o]=t,(0,n.setName)(t,o),t)if(Ue.call(t,a)){var s=t[a]
...
p=m.desc,f=m.value}void 0!==f?("function"==typeof f&&lt(e,d,f,!0),ve(e,d,f,-1!==l.indexOf(d),!i)):void 0!==p&&me(e,d,p,s)}return s.isPrototypeMeta(e)||k(e),e}h.ALIAS_METHOD&&(et=function(e,t,r,n){var i,o=t.methodName,a=r[o],s=n[o]
...
var n=O.get(e)
return void 0!==n&&O.set(r,n),r}var k=Object.prototype.toString,C=Function.prototype.toString,P=Array.isArray,M=Object.keys,x=JSON.stringify,D=100,N=/^[\w$]+$/
...
return E(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return T(this)}},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return w(this)}},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return O(this)}},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return S(this)}},classify:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return A(this)}},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return k(this)}}})}))
...
return(0,this.funcs[n])(e,t)},e}(),P=new C
...
return M(ue(22,t),r)})),P.add(33,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveFree",t),r)})),P.add(34,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveContextualFree",{freeVar:t,context:0}),r)})),P.add(35,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveContextualFree",{freeVar:t,context:1}),r)})),P.add(36,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveContextualFree",{freeVar:t,context:2}),r)})),P.add(37,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveContextualFree",{freeVar:t,context:3}),r)})),P.add(38,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveContextualFree",{freeVar:t,context:4}),r)})),P.add(39,(function(e){var t=e[1],r=e[2]
return M(ue("ResolveContextualFree",{freeVar:t,context:5}),r)})),P.add(29,(function(){return p(void 0)})),P.add(27,(function(e){return[ue("Expr",e[1]),ue(26)]})),P.add(28,(function(e){return[ue("Expr",e[1]),ue(25),ue("JitCompileBlock"),ue(27)]}))
var D={"no-action":!0}
e.NONE=D
var N={"not-handled":!0}
...
function H(e,t){return{syntax:e,encoder:new le,meta:t}}var q=new C,G=["class","id","value","name","type","style","href"],$=["div","span","p","a"]
function W(e){return"string"==typeof e?e:$[e]}function Y(e){return"string"==typeof e?e:G[e]}q.add(3,(function(e){return ue(42,e[1])})),q.add(13,(function(){return ue(55)})),q.add(12,(function(){return ue(54)})),q.add(4,(function(e,t){var r=e[1],n=e[2],i=e[3],o=ne(r,t,"Expected modifier head to be a string")
...
return ue(51,Y(t),r,null!=n?n:null)})),q.add(24,(function(e){var t=e[1],r=e[2],n=e[3]
return ue(108,Y(t),r,null!=n?n:null)})),q.add(15,(function(e){var t=e[1],r=e[2],n=e[3]
return[ue("Expr",r),ue(52,Y(t),!1,null!=n?n:null)]})),q.add(22,(function(e){var t=e[1],r=e[2],n=e[3]
return[ue("Expr",r),ue(52,Y(t),!0,null!=n?n:null)]})),q.add(16,(function(e){var t=e[1],r=e[2],n=e[3]
return[ue("Expr",r),ue(53,Y(t),!1,null!=n?n:null)]})),q.add(23,(function(e){var t=e[1],r=e[2],n=e[3]
return[ue("Expr",r),ue(53,Y(t),!0,null!=n?n:null)]})),q.add(10,(function(e){return ue(48,W(e[1]))})),q.add(11,(function(e){var t=e[1]
...
Object.defineProperty(e,"__esModule",{value:!0}),e.clear=b,e.capabilityFlagsFrom=it,e.hasCapability=at,e.resetDebuggerCallback=function(){Pt=Ct},e.setDebuggerCallback=function(e){Pt=e},e.curry=function(e,t){void 0===t&&(t=null)
...
void 0===n&&(n={})
return{env:new He(e,t),program:new o.RuntimeProgramImpl(r.program.constants,r.program.heap),resolver:new Qe(n)}},e.inTransaction=function(e,t){if(e[Be])t()
else{e.begin()
...
return gr(s,a,u,i)},e.renderAotMain=function(e,t,r,n,i){void 0===i&&(i=new It)
...
return gr(l,u,c,a)},e.renderJitMain=function(e,t,r,n,i,o){void 0===o&&(o=new It)
var a=pr.initial(e,t,{self:r,dynamicScope:o,treeBuilder:n,handle:i})
return new mr(a)},e.renderSync=vr,e.dynamicAttribute=ke,e.clientBuilder=function(e,t){return L.forInitialRender(e,t)},e.isSerializationFirstNode=br,e.rehydrationBuilder=function(e,t){return Er.forInitialRender(e,t)},e.destroy=x,e.registerDestructor=A,e.unregisterDestructor=function(e,t,r){void 0===r&&(r=!1)
0
...
var k,C,P,M=function(){}
function x(e){var t=O(e)
if(!(t.state>=1)){var r=t.parents,n=t.children,i=t.eagerDestructors,o=t.destructors
t.state=1,R(n,x),R(i,(function(t){return t(e)})),R(o,(function(t){return S(e,t)})),M((function(){R(r,(function(t){return function(e,t){var r=O(t)
0===r.state&&(r.children=w(r.children,e))}(e,t)})),t.state=2}))}}function D(e){R(O(e).children,x)}function N(e){var t=_.get(e)
return void 0!==t&&t.state>=1}e._scheduleDestroyed=M,e.enableDestroyableTracking=k,e.assertDestroyablesDestroyed=C
var I=function(){function e(e){this.node=e}return e.prototype.firstNode=function(){return this.node},e}(),j=function(){function e(e){this.node=e}return e.prototype.lastNode=function(){return this.node},e}(),F=(0,r.symbol)("CURSOR_STACK"),L=function(){function e(e,t,n){this.constructing=null,this.operations=null,this[P]=new r.Stack,this.modifierStack=new r.Stack,this.blockStack=new r.Stack,this.pushElement(t,n),this.env=e,this.dom=e.getAppendOperations(),this.updateOperations=e.getDOM()}e.forInitialRender=function(e,t){return new this(e,t.element,t.nextSibling).initialize()},e.resume=function(e,t){var r=new this(e,t.parentElement(),t.reset(e)).initialize()
return r.pushLiveBlock(t),r}
var n=e.prototype
return n.initialize=function(){return this.pushSimpleBlock(),this},n.debugBlocks=function(){return this.blockStack.toArray()},n.block=function(){return this.blockStack.current},n.popElement=function(){this[F].pop(),this[F].current},n.pushSimpleBlock=function(){return this.pushLiveBlock(new z(this.element))},n.pushUpdatableBlock=function(){return this.pushLiveBlock(new U(this.element))},n.pushBlockList=function(e){return this.pushLiveBlock(new V(this.element,e))},n.pushLiveBlock=function(e,t){void 0===t&&(t=!1)
...
return t.parentElement=function(){return this.parent},t.firstNode=function(){return this.first.firstNode()},t.lastNode=function(){return this.last.lastNode()},t.openElement=function(e){this.didAppendNode(e),this.nesting++},t.closeElement=function(){this.nesting--},t.didAppendNode=function(e){0===this.nesting&&(this.first||(this.first=new I(e)),this.last=new j(e))},t.didAppendBounds=function(e){0===this.nesting&&(this.first||(this.first=e),this.last=e)},t.finalize=function(e){null===this.first&&e.appendComment("")},e}(),B=function(e){function r(r){var n
...
e.RemoteLiveBlock=B
var U=function(e){function r(){return e.apply(this,arguments)||this}return(0,t.inheritsLoose)(r,e),r.prototype.reset=function(){x(this)
var e=b(this)
...
var n=r
n=Y(K,n),n=W(K,n,"http://www.w3.org/2000/svg"),e.DOMTreeConstruction=n})(J||(J={}))
...
if(we(ye,a))return"unsafe:"+o}return Te(i,r)?"unsafe:"+o:o}function ke(e,t,r){var n=e.tagName,i={element:e,name:t,namespace:r}
if("http://www.w3.org/2000/svg"===e.namespaceURI)return Ce(n,t,i)
var o=ve(e,t),a=o.type,s=o.normalized
return"attr"===a?Ce(n,s,i):function(e,t,r){if(Ae(e,t))return new Ne(t,r)
...
return new De(t,r)}(n,s,i)}function Ce(e,t,r){return Ae(e,t)?new Ie(r):new Me(r)}var Pe=function(e){this.attribute=e}
...
this.slots[e]=t},e}()
e.ScopeImpl=ze
var Be=(0,r.symbol)("TRANSACTION"),Ue=function(){function e(){this.scheduledInstallManagers=[],this.scheduledInstallModifiers=[],this.scheduledUpdateModifierManagers=[],this.scheduledUpdateModifiers=[],this.createdComponents=[],this.createdManagers=[],this.updatedComponents=[],this.updatedManagers=[]}var t=e.prototype
...
return r.href=e,r.protocol}(e):"undefined"!=typeof document?new URL(e,document.baseURI).protocol:new URL(e,"https://www.example.com").protocol}function Ge(e,t,r,n){return ke(e,t,n)}function $e(e,t){return e[t]}function We(e,t,r){return e[t]=r}function Ye(e){return Boolean(e)}function Je(e){return e&&e[Symbol.iterator]?e[Symbol.iterator]():null}e.EnvironmentImpl=He,xe=Be
...
i.didRenderLayout(o,s),e.env.didCreate(o,i),e.updateWith(new kt(i,o,s))})),Ke.add(101,(function(e){e.commitCacheGroup()}))
...
r.update(t,n)},r}(Xe),kt=function(e){function r(t,r,n){var o
...
function Ct(e,t){console.info("Use `context`, and `get(<path>)` to debug this template."),t("this")}var Pt=Ct
...
Ke.add(106,(function(e,t){var n=t.op1,i=t.op2,o=e[f].getArray(n),a=e[f].getValue((0,r.decodeHandle)(i)),s=new Mt(e.scope(),o,a)
...
var Ft=function(){function e(){this.stack=null,this.positional=new Lt,this.named=new Bt,this.blocks=new Ht}var r=e.prototype
...
r.base+=e,n.base+=e,t[d][a.$sp]+=e}},r.capture=function(){var e=0===this.positional.length?Wt:this.positional.capture(),t=0===this.named.length?$t:this.named.capture()
...
var Bt=function(){function e(){this.base=0,this.length=0,this._references=null,this._names=r.EMPTY_ARRAY,this._atNames=r.EMPTY_ARRAY}var n=e.prototype
...
return-1===i?oe:n.get(i,r)},n.capture=function(){return new Ut(this.tag,this.names,this.references)},n.merge=function(e){var t=e.length
...
function Vt(e){return"&"+e}e.CapturedNamedArgumentsImpl=Ut
...
var $t=new Ut(i.CONSTANT_TAG,r.EMPTY_ARRAY,r.EMPTY_ARRAY),Wt=new zt(i.CONSTANT_TAG,r.EMPTY_ARRAY),Yt=new Gt(i.CONSTANT_TAG,Wt,$t,0)
e.EMPTY_ARGS=Yt
...
function Rr(e){return 8===e.nodeType}function wr(e){return 8===e.nodeType&&0===e.nodeValue.lastIndexOf("%-b:",0)}function Or(e){return parseInt(e.nodeValue.slice(4),10)}function Tr(e){return 1===e.nodeType}function Ar(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function Sr(e){return 8===e.nodeType&&"% %"===e.nodeValue}function kr(e,t){for(var r=0;r<e.length;r++){var n=e[r]
...
var k=function(){}
var C=new WeakMap
function P(e,t){var r=C.get(e)
if(void 0!==r){var n=r.get(t)
void 0!==n&&(p(n),k())}}function M(e){var t=C.get(e)
return void 0===t&&(t=new Map,C.set(e,t)),t}function x(e,t,r){var n=void 0===r?M(e):r,i=n.get(t)
...
var B=o("FN"),U=o("LAST_VALUE"),V=o("TAG"),H=o("SNAPSHOT")
o("DEBUG_LABEL")
function q(e,t){var r
var n=((r={})[B]=e,r[U]=void 0,r[V]=void 0,r[H]=-1,r)
return n}function G(e){W(e,"getValue")
var t=e[B],r=e[V],n=e[H]
if(void 0!==r&&c(r,n))L(r)
else{j()
try{e[U]=t()}finally{r=F(),e[V]=r,e[H]=l(r),L(r)}}return e[U]}function $(e){W(e,"isConst")
var t=e[V]
...
e=o[0],t=o[1],void 0===(n=o[2])?i=0:s(i=n.pop())||(r=!0===i,i=n.pop())}return[e,t,n,i=parseInt(i,10),r]}var E=0,R=0,w=0,O=0,T=0,A=0,S=0,k=0,C=0,P=0,M=0,x=0,D=0,N=0,I=0,j=0,F=0,L=0,z=0,B=0,U=0,V=function(){function e(e,t){var r=this
...
return C.ENCODE_AND_DECODE_PATH_SEGMENTS?h(r):r},b[2]=function(e,t){return v(t,e.value)},b[4]=function(){return""}
...
C.prototype.add=function(e,t){for(var r,n=this.rootState,i="^",o=[0,0,0],a=new Array(e.length),s=[],u=!0,l=0,c=0;c<e.length;c++){for(var d=e[c],h=R(s,d.path,o),f=h.names,p=h.shouldDecodes;l<s.length;l++){var m=s[l]
4!==m.type&&(u=!1,n=n.put(47,!1,!1),i+="/",n=g[m.type](m,n),i+=y[m.type](m))}a[c]={handler:d.handler,names:f,shouldDecodes:p}}u&&(n=n.put(47,!1,!1),i+="/"),n.handlers=a,n.pattern=i+"$",n.types=o,"object"==typeof t&&null!==t&&t.as&&(r=t.as),r&&(this.names[r]={segments:s,handlers:a})},C.prototype.handlersFor=function(e){var t=this.names[e]
...
var m=c[p],v=o&&o[a++]
h===_&&(h={}),C.ENCODE_AND_DECODE_PATH_SEGMENTS&&d[p]?h[m]=v&&decodeURIComponent(v):h[m]=v}s[u]={handler:l.handler,params:h,isDynamic:f}}return s}(p,l,n)),t},C.VERSION="0.3.4",C.ENCODE_AND_DECODE_PATH_SEGMENTS=!0,C.Normalizer={normalizeSegment:c,normalizePath:u,encodePathSegment:h},C.prototype.map=function(e,t){var r=new i
...
return new C(this.router,e,t,i)},t}(M),I=function(){function e(t){var r=Error.call(this,t)
...
return t||(t=e._promiseCallbacks={}),t}Object.defineProperty(e,"__esModule",{value:!0}),e.asap=K,e.all=x,e.allSettled=N,e.race=I,e.hash=F,e.hashSettled=z,e.rethrow=B,e.defer=U,e.denodeify=C,e.configure=a,e.on=me,e.off=ve,e.resolve=q,e.reject=G,e.map=H,e.filter=Y,e.async=e.EventTarget=e.Promise=e.cast=e.default=void 0
...
return n[r]=function(e,r){e?v(u,e):void 0===t?f(u,r):!0===t?f(u,S(arguments)):Array.isArray(t)?f(u,A(arguments,t)):f(u,r)},i?M(u,n,e,this):P(u,n,e,this)}
return r.__proto__=e,r}function P(e,t,r,n){try{r.apply(n,t)}catch(i){v(e,i)}return e}function M(e,t,r,n){return T.all(t).then((function(t){return P(e,t,r,n)}))}function x(e,t){return T.all(e,t)}e.Promise=T,T.cast=l,T.all=function(e,t){return Array.isArray(e)?new E(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},T.race=function(e,t){var r=new this(c,t)
...
return new V(T,e,t,r).promise}))}function q(e,t){return T.resolve(e,t)}function G(e,t){return T.reject(e,t)}var $={},W=function(e){function t(){return e.apply(this,arguments)||this}(0,r.inheritsLoose)(t,e)
var n=t.prototype
...
return new W(T,e,t,r).promise}))}var J,Q=0
...
for(var ye in a("instrument",!0),ge)ge.hasOwnProperty(ye)&&me(ye,ge[ye])}var be={asap:K,cast:fe,Promise:T,EventTarget:i,all:x,allSettled:N,race:I,hash:F,hashSettled:z,rethrow:B,defer:U,denodeify:C,configure:a,on:me,off:ve,resolve:q,reject:G,map:H,async:pe,filter:Y}
...
function S(e,t){return A.create({promise:Ember.RSVP.Promise.resolve(e,t)})}function k(e,t){return T.create({promise:Ember.RSVP.Promise.resolve(e,t)})}function C(e,t){return S(e.then((function(e){return e.getRecord()})),t)}var P,M=new Ember._Backburner(["normalizeRelationships","syncRelationships","finished"]),x=/^\/?data\/(attributes|relationships)\/(.*)/,D=/^\/?data/,N="base"
function I(e){var t={}
...
return void 0===t&&(t=this._map[e]=new $(e)),t},t.clear=function(){for(var e=this._map,t=Object.keys(e),r=0;r<t.length;r++){e[t[r]].clear()}},e}(),Y=new WeakMap,J=new WeakMap
...
return r=function(e){return J.get(e)}(e)?e:t.store.push(e),t.belongsToRelationship.setCanonicalRecordData(j(r)),r}))},i.value=function(){var e=this.parentInternalModel.store,t=this._resource()
...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function ve(e,t){return function(e){return j(e)._relationships}(e).get(t)}var ge,ye,be,_e,Ee=Object.prototype.hasOwnProperty,Re=!1
...
void 0!==c&&(a="hasMany"===c.kind?Ce(e[l]):Pe(e[l]),e[l]=a)}}var d=this._recordData._initRecordCreateOptions(e)
...
this.hasRecord&&this._record._notifyProperties(t),this.pushedData()},o.getAttributeValue=function(e){return this._recordData.getAttr(e)},o.setDirtyHasMany=function(e,t){return this._recordData.setDirtyHasMany(e,Ce(t))},o.setDirtyBelongsTo=function(e,t){return this._recordData.setDirtyBelongsTo(e,Pe(t))},o.setDirtyAttribute=function(e,t){if(this.isDeleted())throw new Ember.Error("Attempted to set '"+e+"' to '"+t+"' on the deleted record "+this)
...
throw o&&"belongsTo"===r.kind&&o.content&&o.content.isDestroying&&o.set("content",null),i}return r.setHasFailedLoadAttempt(!1),r.setRelationshipIsStale(!1),n}function Ce(e){return e.map(Pe)}function Pe(e){if(!e)return null
...
function Ye(e){return e}function Je(e,t){for(var r=0;r<t.length;r++){var n=t[r]
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}var Qe,Ke=function(){function e(e){this._store=e,this[We]=void 0,this._willUpdateManyArrays=void 0,this._pendingManyArrayUpdates=void 0,this._willUpdateManyArrays=!1,this._pendingManyArrayUpdates=[]}var t,r,n,i=e.prototype
...
return!1!==r.reload&&(n.shouldReloadAll&&n.shouldReloadAll(this,i)||!n.shouldReloadAll&&0===i.length)?(Ember.set(t,"isUpdating",!0),k($e(n,this,e,r))):(!1===r.backgroundReload||(r.backgroundReload||!n.shouldBackgroundReloadAll||n.shouldBackgroundReloadAll(this,i))&&(Ember.set(t,"isUpdating",!0),$e(n,this,e,r)),k(Ember.RSVP.Promise.resolve(t)))},d._didUpdateAll=function(e){this.recordArrayManager._didUpdateAll(e)},d.peekAll=function(e){var t=o(e)
...
var c=u
return o.push([3,2]),r()}([function(e,t){window._eai_r=require,window._eai_d=define},,function(e,t){},function(e,t,r){r(0),e.exports=r(4)},function(e,t,r){var n,i,o
"undefined"!=typeof document&&(r.p=(n=document.querySelectorAll("script"))[n.length-1].src.replace(/\/[^/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("broadcast-channel",[],(function(){return r(8)})))},function(e,t){}]);(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[2],{1:function(e,t){e.exports=!1},8:function(e,t,r){"use strict"
function n(e){return e||(e=0),new Promise((function(t){return setTimeout(t,e)}))}function i(){return Math.random().toString(36).substring(2)}r.r(t)
var o=0,a=0
function s(){var e=(new Date).getTime()
return e===o?1e3*e+ ++a:(o=e,a=0,1e3*e)}var u="[object process]"===Object.prototype.toString.call("undefined"!=typeof process?process:0),l={create:function(e){var t={messagesCallback:null,bc:new BroadcastChannel(e),subFns:[]}
return t.bc.onmessage=function(e){t.messagesCallback&&t.messagesCallback(e.data)},t},close:function(e){e.bc.close(),e.subFns=[]},onMessage:function(e,t){e.messagesCallback=t},postMessage:function(e,t){e.bc.postMessage(t,!1)},canBeUsed:function(){if(u&&"undefined"==typeof window)return!1
...
return!0}return!1},type:"native",averageResponseTime:function(){return 150},microSeconds:s}
function c(){return(new Date).getTime()}var d=function(e){var t=new Set,r=new Map
this.has=t.has.bind(t),this.add=function(n){r.set(n,c()),t.add(n),function(){for(var n=c()-e,i=t[Symbol.iterator]();;){var o=i.next().value
if(!o)return
if(!(r.get(o)<n))return
r.delete(o),t.delete(o)}}()},this.clear=function(){t.clear(),r.clear()}}
function h(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=JSON.parse(JSON.stringify(e))
...
if(void 0!==window.msIndexedDB)return window.msIndexedDB}return!1}function p(e){return e.closed?Promise.resolve():e.messagesCallback?(t=e.db,r=e.lastCursorId,n=t.transaction("messages").objectStore("messages"),i=[],o=IDBKeyRange.bound(r+1,1/0),new Promise((function(e){n.openCursor(o).onsuccess=function(t){var r=t.target.result
r?(i.push(r.value),r.continue()):e(i)}}))).then((function(t){return t.filter((function(e){return!!e})).map((function(t){return t.id>e.lastCursorId&&(e.lastCursorId=t.id),t})).filter((function(t){return function(e,t){return!(e.uuid===t.uuid||t.eMIs.has(e.id)||e.data.time<t.messagesCallbackTime)}(t,e)})).sort((function(e,t){return e.time-t.time})).forEach((function(t){e.messagesCallback&&(e.eMIs.add(t.id),e.messagesCallback(t.data))})),Promise.resolve()})):Promise.resolve()
var t,r,n,i,o}var m={create:function(e,t){return t=h(t),function(e){var t="pubkey.broadcast-channel-0-"+e,r=f().open(t,1)
return r.onupgradeneeded=function(e){e.target.result.createObjectStore("messages",{keyPath:"id",autoIncrement:!0})},new Promise((function(e,t){r.onerror=function(e){return t(e)},r.onsuccess=function(){e(r.result)}}))}(e).then((function(r){var o={closed:!1,lastCursorId:0,channelName:e,options:t,uuid:i(),eMIs:new d(2*t.idb.ttl),writeBlockPromise:Promise.resolve(),messagesCallback:null,readQueuePromises:[],db:r}
return r.onclose=function(){o.closed=!0,t.idb.onclose&&t.idb.onclose()},function e(t){t.closed||p(t).then((function(){return n(t.options.idb.fallbackInterval)})).then((function(){return e(t)}))}(o),o}))},close:function(e){e.closed=!0,e.db.close()},onMessage:function(e,t,r){e.messagesCallbackTime=r,e.messagesCallback=t,p(e)},postMessage:function(e,t){return e.writeBlockPromise=e.writeBlockPromise.then((function(){return function(e,t,r){var n={uuid:t,time:(new Date).getTime(),data:r},i=e.transaction(["messages"],"readwrite")
return new Promise((function(e,t){i.oncomplete=function(){return e()},i.onerror=function(e){return t(e)},i.objectStore("messages").add(n)}))}(e.db,e.uuid,t)})).then((function(){0===(0,10,Math.floor(11*Math.random()+0))&&function(e,t){(function(e,t){var r=(new Date).getTime()-t,n=e.transaction("messages").objectStore("messages"),i=[]
return new Promise((function(e){n.openCursor().onsuccess=function(t){var n=t.target.result
if(n){var o=n.value
if(!(o.time<r))return void e(i)
i.push(o),n.continue()}else e(i)}}))})(e,t).then((function(t){return Promise.all(t.map((function(t){return function(e,t){var r=e.transaction(["messages"],"readwrite").objectStore("messages").delete(t)
return new Promise((function(e){r.onsuccess=function(){return e()}}))}(e,t.id)})))}))}(e.db,e.options.idb.ttl)})),e.writeBlockPromise},canBeUsed:function(){return!u&&!!f()},type:"idb",averageResponseTime:function(e){return 2*e.idb.fallbackInterval},microSeconds:s}
function v(){var e
if("undefined"==typeof window)return null
try{e=window.localStorage,e=window["ie8-eventlistener/storage"]||window.localStorage}catch(e){}return e}function g(e){return"pubkey.broadcastChannel-"+e}function y(){if(u)return!1
var e=v()
if(!e)return!1
try{var t="__broadcastchannel_check"
e.setItem(t,"works"),e.removeItem(t)}catch(e){return!1}return!0}var b={create:function(e,t){if(t=h(t),!y())throw new Error("BroadcastChannel: localstorage cannot be used")
var r=i(),n=new d(t.localstorage.removeTimeout),o={channelName:e,uuid:r,eMIs:n}
return o.listener=function(e,t){var r=g(e),n=function(e){e.key===r&&t(JSON.parse(e.newValue))}
return window.addEventListener("storage",n),n}(e,(function(e){o.messagesCallback&&e.uuid!==r&&e.token&&!n.has(e.token)&&(e.data.time&&e.data.time<o.messagesCallbackTime||(n.add(e.token),o.messagesCallback(e.data)))})),o},close:function(e){var t
t=e.listener,window.removeEventListener("storage",t)},onMessage:function(e,t,r){e.messagesCallbackTime=r,e.messagesCallback=t},postMessage:function(e,t){return new Promise((function(r){n().then((function(){var n=g(e.channelName),o={token:i(),time:(new Date).getTime(),data:t,uuid:e.uuid},a=JSON.stringify(o)
v().setItem(n,a)
var s=document.createEvent("Event")
s.initEvent("storage",!0,!0),s.key=n,s.newValue=a,window.dispatchEvent(s),r()}))}))},canBeUsed:y,type:"localstorage",averageResponseTime:function(){var e=navigator.userAgent.toLowerCase()
return e.includes("safari")&&!e.includes("chrome")?240:120},microSeconds:s},_=s,E=new Set,R={create:function(e){var t={name:e,messagesCallback:null}
return E.add(t),t},close:function(e){E.delete(e)},onMessage:function(e,t){e.messagesCallback=t},postMessage:function(e,t){return new Promise((function(r){return setTimeout((function(){Array.from(E).filter((function(t){return t.name===e.name})).filter((function(t){return t!==e})).filter((function(e){return!!e.messagesCallback})).forEach((function(e){return e.messagesCallback(t)})),r()}),5)}))},canBeUsed:function(){return!0},type:"simulate",averageResponseTime:function(){return 5},microSeconds:_},w=[l,m,b]
if(u){var O=r(5)
"function"==typeof O.canBeUsed&&w.push(O)}function T(e){var t=[].concat(e.methods,w).filter(Boolean)
if(e.type){if("simulate"===e.type)return R
var r=t.find((function(t){return t.type===e.type}))
if(r)return r
throw new Error("method-type "+e.type+" not found")}e.webWorkerSupport||u||(t=t.filter((function(e){return"idb"!==e.type})))
var n=t.find((function(e){return e.canBeUsed()}))
if(n)return n
throw new Error("No useable methode found:"+JSON.stringify(w.map((function(e){return e.type}))))}var A,S=function(e,t){var r,n,i
this.name=e,A&&(t=A),this.options=h(t),this.method=T(this.options),this._iL=!1,this._onML=null,this._addEL={message:[],internal:[]},this._befC=[],this._prepP=null,(i=n=(r=this).method.create(r.name,r.options))&&"function"==typeof i.then?(r._prepP=n,n.then((function(e){r._state=e}))):r._state=n}
function k(e){var t=T(e=h(e))
return"node"===t.type?t.clearNodeFolder().then((function(){return!0})):Promise.resolve(!1)}function C(e){A=e}function P(e,t,r){var n={time:e.method.microSeconds(),type:t,data:r}
return(e._prepP?e._prepP:Promise.resolve()).then((function(){return e.method.postMessage(e._state,n)}))}function M(e){return e._addEL.message.length>0||e._addEL.internal.length>0}function x(e,t,r){e._addEL[t].push(r),function(e){if(!e._iL&&M(e)){var t=function(t){e._addEL[t.type].forEach((function(e){t.time>=e.time&&e.fn(t.data)}))},r=e.method.microSeconds()
e._prepP?e._prepP.then((function(){e._iL=!0,e.method.onMessage(e._state,t,r)})):(e._iL=!0,e.method.onMessage(e._state,t,r))}}(e)}function D(e,t,r){e._addEL[t]=e._addEL[t].filter((function(e){return e!==r})),function(e){if(e._iL&&!M(e)){e._iL=!1
var t=e.method.microSeconds()
e.method.onMessage(e._state,null,t)}}(e)}S._pubkey=!0,S.prototype={postMessage:function(e){if(this.closed)throw new Error("BroadcastChannel.postMessage(): Cannot post message after channel has closed")
return P(this,"message",e)},postInternal:function(e){return P(this,"internal",e)},set onmessage(e){var t={time:this.method.microSeconds(),fn:e}
D(this,"message",this._onML),e&&"function"==typeof e?(this._onML=t,x(this,"message",t)):this._onML=null},addEventListener:function(e,t){x(this,e,{time:this.method.microSeconds(),fn:t})},removeEventListener:function(e,t){D(this,e,this._addEL[e].find((function(e){return e.fn===t})))},close:function(){var e=this
if(!this.closed){this.closed=!0
var t=this._prepP?this._prepP:Promise.resolve()
return this._onML=null,this._addEL.message=[],t.then((function(){return Promise.all(e._befC.map((function(e){return e()})))})).then((function(){return e.method.close(e._state)}))}},get type(){return this.method.type}}
var N=r(1),I=r.n(N),j={add:function(e){if("function"==typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope);else{if("function"!=typeof window.addEventListener)return
window.addEventListener("beforeunload",(function(){e()}),!0),window.addEventListener("unload",(function(){e()}),!0)}}},F=r(2),L=r.n(F),z=I.a?L.a:j,B=new Set,U=!1
function V(){var e=[]
return B.forEach((function(t){e.push(t()),B.delete(t)})),Promise.all(e)}var H=function(e){if(U||(U=!0,z.add(V)),"function"!=typeof e)throw new Error("Listener is no function")
return B.add(e),{remove:function(){return B.delete(e)},run:function(){return B.delete(e),e()}}},q=function(e,t){this._channel=e,this._options=t,this.isLeader=!1,this.isDead=!1,this.token=i(),this._isApl=!1,this._reApply=!1,this._unl=[],this._lstns=[],this._invs=[]}
function G(e,t){var r={context:"leader",action:t,token:e.token}
return e._channel.postInternal(r)}function $(e,t){if(e._leaderElector)throw new Error("BroadcastChannel already has a leader-elector")
...
var r=new q(e,t)
return e._befC.push((function(){return r.die()})),e._leaderElector=r,r}q.prototype={applyOnce:function(){var e=this
...
this._isApl=!0
var t=!1,r=[],i=function(n){"leader"===n.context&&n.token!=e.token&&(r.push(n),"apply"===n.action&&n.token>e.token&&(t=!0),"tell"===n.action&&(t=!0))}
return this._channel.addEventListener("internal",i),G(this,"apply").then((function(){return n(e._options.responseTime)})).then((function(){return t?Promise.reject(new Error):G(e,"apply")})).then((function(){return n(e._options.responseTime)})).then((function(){return t?Promise.reject(new Error):G(e)})).then((function(){return function(e){e.isLeader=!0
var t=H((function(){return e.die()}))
e._unl.push(t)
var r=function(t){"leader"===t.context&&"apply"===t.action&&G(e,"tell")}
return e._channel.addEventListener("internal",r),e._lstns.push(r),G(e,"tell")}(e)})).then((function(){return!0})).catch((function(){return!1})).then((function(t){return e._channel.removeEventListener("internal",i),e._isApl=!1,!t&&e._reApply?(e._reApply=!1,e.applyOnce()):t}))},awaitLeadership:function(){var e
return this._aLP||(this._aLP=(e=this).isLeader?Promise.resolve():new Promise((function(t){var r=!1,n=function(){r||(r=!0,clearInterval(i),e._channel.removeEventListener("internal",o),t(!0))}
e.applyOnce().then((function(){e.isLeader&&n()}))
var i=setInterval((function(){e.applyOnce().then((function(){e.isLeader&&n()}))}),e._options.fallbackInterval)
e._invs.push(i)
var o=function(t){"leader"===t.context&&"death"===t.action&&e.applyOnce().then((function(){e.isLeader&&n()}))}
e._channel.addEventListener("internal",o),e._lstns.push(o)}))),this._aLP},die:function(){var e=this
if(!this.isDead)return this.isDead=!0,this._lstns.forEach((function(t){return e._channel.removeEventListener("internal",t)})),this._invs.forEach((function(e){return clearInterval(e)})),this._unl.forEach((function(e){e.remove()})),G(this,"death")}},r.d(t,"BroadcastChannel",(function(){return S})),r.d(t,"clearNodeFolder",(function(){return k})),r.d(t,"enforceOptions",(function(){return C})),r.d(t,"createLeaderElection",(function(){return $}))}}])
