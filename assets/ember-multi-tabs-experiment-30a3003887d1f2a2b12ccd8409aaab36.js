...
var t=Ember.HTMLBars.template({id:"6U9MLyIG",block:'{"symbols":[],"statements":[[10,"h1"],[12],[2,"Ember multi-tabs experiment"],[13],[2,"\\n"],[10,"p"],[12],[2,"After opening several browser tabs updating the input field causes update of others"],[13],[2,"\\n"],[8,"share-state",[],[[],[]],null]],"hasEval":false,"upvars":[]}',meta:{moduleName:"ember-multi-tabs-experiment/templates/application.hbs"}})
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("ember-multi-tabs-experiment/app").default.create({name:"ember-multi-tabs-experiment",version:"0.0.0+717d1d8b"})
